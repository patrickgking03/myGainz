  ...
  return (
    <div className="flex h-full flex-col space-y-6">
      <div>
        ...
        <h2 className="page-header text-gray-400 text-lg"><span className="page-header text-gray-500 text-lg">Page {page + 1}</span> ({excercises.length} Results)</h2>
      </div>
      ...
      <div className="flex justify-between items-center">
        ...
        <p className="text-gray-400 select-none hidden md:inline">Showing 12 per page</p>
