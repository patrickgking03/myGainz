export default function ExcerciseCard({ excercise }) {
  return <div className="w-full aspect-square bg-gray-100 p-4 rounded-lg">
    ...
    <img src={excercise.gifUrl} alt="gif" className="rounded-lg bg-white border-2 border-slate-200 aspect-square w-full" />
  </div>;
}