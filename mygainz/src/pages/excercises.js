...
export default function Excercises() {
  ...
  return (
    <div className="flex h-full flex-col space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-12 gap-y-8 overflow-scroll scrollbar-hide h-full">
      ...
      <div className="flex justify-between">
        ...
        <div className="w-2/3 h-12 mx-8 flex justify-end items-center relative rounded-lg border-2 bg-gray-100 border-gray-200 px-4 focus:outline-blue-500">
