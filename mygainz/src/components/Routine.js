...
export default function Routine({ routine, toggleModal, setCurrentDay }) {
  return <>
    <div className=" md:w-full bg-gray-100 p-8 rounded-lg border border-gray-200 scrollbar-hide space-y-6">
      ...
      <div className="flex flex-wrap text-center items-center w-full gap-6">
        {routine.days.map(day => {
          ...
          return <button onClick={() => {
            toggleModal();
            setCurrentDay(day);
          }} className="text-sm w-48 h-14 rounded-md flex-grow text-white bg-blue-500 p-4 hover:outline outline-2 outline-offset-1 outline-blue-500 flex items-center justify-center">
